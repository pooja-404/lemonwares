            ...
            <div className='max-w-[1194px] mx-auto px-3 md:pt-28 pt-16'>
                <div className='flex flex-wrap flex-row -mx-3'>
                    <div className='lg:w-1/2 w-full px-3 flex flex-col lg:items-end'>
                        ...
                        <div className='rounded-[8px] shadow-[0px_10px_20px_0px_#29292A12] p-[7px_32px_96px_64px] lg:max-w-[350px] lg:mt-9 mt-8 relative' data-aos="fade-up"
                    ...
                    <div className='lg:w-1/2 w-full px-3 lg:pt-8'>
                        <div className='rounded-[8px] shadow-[0px_10px_20px_0px_#29292A12] p-[39px_32px_14px_64px] lg:max-w-[445px] lg:mt-10 mt-8 relative' data-aos="fade-up"
